...
import fr.logkey.apisup.SendNotificationPack.APIService
import fr.logkey.apisup.SendNotificationPack.MyResponse
import fr.logkey.apisup.SendNotificationPack.NotificationSender
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

import fr.logkey.apisup.SendNotificationPack.*
...
class SendNotifActivity : AppCompatActivity() {
    ...
    private fun UpdateToken(){
        ...
        var token: fr.logkey.apisup.SendNotificationPack.Token = Token(refreshToken)
